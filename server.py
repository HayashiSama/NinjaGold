...
def moneys():
  ...
  if value=='farm':
    ...
    session['money']+= val
    session['activity'] = "Entered the farm and got " + str(val) + " gold.\n" + session['activity']
  elif value=='cave':
    val = random.randint(5, 10)
    session['money']+= val
    session['activity'] = "Entered the cave and got " + str(val) + " gold.\n" + session['activity']
  elif value == 'house':
    val = random.randint(2, 5)
    session['money']+= val
    session['activity'] = "Entered the house and got " + str(val) + " gold.\n" + session['activity']
  elif value=='casino':
    val = random.randint(-50, 50)
    session['money']+= val
    session['activity'] = "Entered the casino and got " + str(val) + " gold.\n" + session['activity']
